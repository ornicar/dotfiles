    ...
    in
    {
      ...
      lila-ws = {
        ...
        Service = {
          ...
          ExecStart = "${bloop} run lila-ws -- -J-Dcsrf.origin=https://l.org -J-Dlogback.configurationFile=logback.dev.xml -J-Dkamon.influxdb.hostname=monitor.lichess.ovh";
          ExecStop = "${pkgs.psmisc}/bin/fuser -k 9664/tcp -TERM";
        };
        Install = {
          WantedBy = [ "lila.target" ];
        };
      };
      lila-fishnet = {
        Unit = {
