...
set wildignore=.svn,CVS,.git,.hg,*.o,*.a,*.class,*.jar,*.mo,*.la,*.so,*.obj,*.swp,*.jpg,*.png,*.xpm,*.gif,*.pyc,*.pyo,**/cache/*,**/logs/*,**/target/*,*.hi,tags,**/dist/*,**/public/**/vendor/**,**/public/vendor/**
...
set statusline=%{substitute(getcwd(),'^.*/','','')}\ %<%.99f\ %h%w%m%r%y%=%-16(\ %#warningmsg#%{SyntasticStatuslineFlag()}%*\ %l,%c-%v\ %)%P
...
let g:syntastic_mode_map = { 'mode': 'active',
                           \ 'passive_filetypes': ['scala', 'haskell', 'java'] }
