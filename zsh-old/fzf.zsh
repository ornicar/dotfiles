...
export FZF_DEFAULT_COMMAND='aaaaaag --silent --hidden --skip-vcs-ignores --nocolor --ignore .git --ignore .bloop --ignore node_modules --ignore target --ignore .cache --ignore venv --ignore .mypy_cache --ignore __pycache__ -g ""'
